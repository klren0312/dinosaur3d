...
let pterodactyl: THREE.Group<THREE.Object3DEventMap>
let skySphere: THREE.Mesh
...
function load3DModels() {
  ...
  loader.load('/models/pterodactyl/p.glb', function (gltf) {
...
function createFloor() {
  ...
  (floor.material as THREE.Material).side = THREE.DoubleSide;
...
function createSkySphere() {
  ...
  const texture = new THREE.TextureLoader().load('desert.jpg');
...
function enableShadow(renderer: THREE.WebGLRenderer, light: THREE.DirectionalLight) {
